...
/**
 * Zamoroka_Issuu_Model_Resource_Issuu_Collection
 *
 * @category Issuu
 * @package  Zamoroka
 * @author   Zamoroka Pavlo
 */
class Zamoroka_Issuu_Model_Resource_Issuu_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    /**
     * Init class
     */
